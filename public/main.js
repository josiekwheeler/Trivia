...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.addScores = function (newScore) {
        return this.http.get("/api.scores", { responseType: "json" });
    };
...
var AppComponent = /** @class */ (function () {
    function AppComponent(apiService) {
        ...
        this.apiService.getScores().subscribe(function (response) {
...
var ScoresComponent = /** @class */ (function () {
    function ScoresComponent(apiService) {
        var _this = this;
        this.apiService = apiService;
        this.apiService.getScores().subscribe(function (response) {
            _this.scores = response;
...
module.exports = __webpack_require__(/*! /Users/josiekwheeler/Documents/TriviaProject/src/main.ts */"./src/main.ts");
